...
\\
\\
screeny: Historii, admin panelu, edycja pytania, udzielanie odpowiedzi, raport, wysyłanie maila, toast notification, ekran startowy
xml: edycji pytania, ekanu startowego, raportu, pytania
...
\paragraph{Toast Notification}

\paragraph{SQL Data}

\paragraph{Create view dynamically}
